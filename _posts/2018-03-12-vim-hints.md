...
Usage hint for the [abolish](https://github.com/tpope/vim-abolish) plugin.

Substitute `old` pattern with `new` pattern no matter the case including
snake_case, camelCase or MixCase.

```viml
:%S/<old-pattern>/<new-patter>/
```
